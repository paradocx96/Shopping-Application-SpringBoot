...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(Long id, String username, int contactNo, String email, String password,
	...
	public static UserDetailsImpl build(User user) {
		...
		System.out.println("-----------------------------" + user.getRoles().stream()
				.map(role -> new SimpleGrantedAuthority(role.getName().name())).toString());
